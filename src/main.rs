...
mod tests {
    ...
    fn check_dirs_error_msg(){
        ...
        assert_eq!(check_dirs(), "This program you've just run does not appear to be in the Downloads folder, please try running it again with it in the Downloads folder")
    }
